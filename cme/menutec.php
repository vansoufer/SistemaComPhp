 ...
 <div>
  ...
  <ul>
    <li><a href="menu.php"><img src="imagens/logo.png" height="50" width="100" border-left="5" border-right="5"/></a>
        <li><a href="#" style="padding-top:18px;height:70px;">Chamados<br><br><br></a>
    <ul>
            <li><a href="ostecnico.php">Solicitações Pendentes</a></li>
            <li><a href="buscaos.php">Pesquisar Chamados</a></li>
    </ul></ul>
