...
<font color="black"> Pesquisa por Equipamentos
<form action="" method="post">
    ...
    $chamada = "SELECT * FROM equipamentos WHERE nome LIKE '%".$pesquisar."%' or codigo = '".$pesquisar."' LIMIT 5";
	...
	while($chamada2 = mysqli_fetch_array($chamada1)){
		...
		echo "Data da Compra: ".$chamada2['dtcompra']."<br>";
		echo "Setor: ".$chamada2['setor']."<br>";
		echo "Data Fabricação: ".$chamada2['dtfabricacao']."<br>";
		echo "Garantia: ".$chamada2['tpgarantia']."<br>";
		echo "Descrição: ".$chamada2['descricao']."<br><br>";
		echo "<a href='editarequipa.php?id=".$chamada2['codigo']."'><img src='imagens/lapis1.png' style='max-width:30px'> Editar</a><br><br>";
