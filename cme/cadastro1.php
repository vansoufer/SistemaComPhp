...
<body background="imagens/logo1.png" bgproperties="fixed" >
 ...
 <div>
  ...
  <ul>
    ...
    <ul>
      <li><a href="cadastro1.php?p=formulario1">Cadastrar Funcionários</a></li>
            <li><a href="cadastro1.php?p=formulario2">Cadastrar Setores</a></li>
            <li><a href="cadastro1.php?p=formulario3">Cadastrar Equipamentos</a></li>
            <li><a href="cadastro1.php?p=formulario4">Cadastrar Fornecedor</a></li> 
      <li><a href="cadastro1.php?p=formulario5">Cadastrar Itens</a></li>  
    </ul></ul>
    ...
    <div id="conteudoEsq"> 
		<nav class="navigation">
			...
			<a href="menu1.php"><img src="imagens/relatorios.png"><br>Relatorios<br><br><br></a>
