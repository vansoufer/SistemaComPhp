...
<div class="campo"> 
<label>Relatório de Ordem de Serviço por Setor</label></div></fieldset>
<form action="pdfsetor.php" method="post">

<fieldset>
        <fieldset class="grupo">
            <div class="campo">
			<label for="nome">Nome do Setor:</label>
			<input type='text' name='nomeset' id='nomeset' size='20' required="required" >
			</div>
		</fieldset>
