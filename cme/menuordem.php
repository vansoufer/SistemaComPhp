 ...
 <div>
  ...
  <ul>
    <li><a href=""><img src="imagens/logo.png" height="50" width="100" border-left="5" border-right="5"/></a>
        <li><a href="menuordem.php?p=ordem1" style="padding-top:18px;height:70px;">Gerar Ordem de Serviço<br><br><br></a></li>  
    
    <ul>
        <li><a href="buscarordem.php" style="padding-top:18px;height:70px;"> Pesquisar Ordem de Servço<br><br><br></a>
