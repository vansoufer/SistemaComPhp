...
$sql = mysqli_query($conexao,"INSERT INTO  itens (tipoitem, nome, descricao) VALUES 
('$tipoitem', '$nome', '$descricao')");
echo "<font color=#333><center><br><br><br><br><br><h1>Cadastro realizado com sucesso</h1></center>";
mysqli_close($conexao);
?>
<center><a href="./cadastro1.php?p=formulario5">Clique aqui para </a> para novo cadastro</center>
</div>
</body>
</html>