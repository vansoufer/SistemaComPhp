...
$prodforn = $_POST['prodforn'];

$sql = mysqli_query($conexao,"INSERT INTO  fornecedores (cnpj, razao, endereco, telefone, prodforn) VALUES 
('$cnpj', '$razao', '$endereco', '$telefone', '$prodforn')");
echo "<font color=#333><center><br><br><br><br><br><h1>Cadastro realizado com sucesso</h1></center>";
mysqli_close($conexao);
?>

<center><a href="./cadastro1.php?p=formulario4">Clique aqui para </a> para novo cadastro</center>
</div>
</body>
</html>