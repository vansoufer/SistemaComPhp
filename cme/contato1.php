 ...
 <div>
  ...
  <ul>
    <li><a href="menu.php"><img src="imagens/logo.png" height="50" width="100" border-left="5" border-right="5"/></a>
        <li><a href="menu.php" style="padding-top:18px;height:70px;">Home<br><br><br></a>
    </ul>
...
<div id="conteudoEsq"> 
		<nav class="navigation">
			...
			<a href="contato.php"><img src="imagens/telefone.png" style="max-width:30px"><br> Contato </a>
			</ul>
		</nav>
      </div>
      <div id="colEsq">
