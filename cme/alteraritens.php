...
$tipoitem = filter_input(INPUT_POST,'tipoitem', FILTER_SANITIZE_STRING);
$nome = filter_input(INPUT_POST,'nome', FILTER_SANITIZE_STRING);
$descricao = filter_input(INPUT_POST,'descricao', FILTER_SANITIZE_STRING);


$chamada = "UPDATE itens SET tipoitem='$tipoitem', nome='$nome', descricao='$descricao' WHERE codigo='$codigo'";
