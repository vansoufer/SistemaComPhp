...
<div class="campo"> 
<label>Relatório de Equipamentos</label></div></fieldset>
<form action="pdfequipamentos.php" method="post">

<fieldset>
        <fieldset class="grupo">
            <div class="campo">
			<label for="nome">Nome do equipamento:</label>
			<input type='text' name='nomeequip' id='nomeequip' size='20' required="required">
			</div>
		</fieldset>
		<fieldset>
        <fieldset class="grupo">
