...
$login = $_POST['login'];
$senha = $_POST['senha'];
$sql = mysqli_query($conexao,"INSERT INTO  users (nome, sobrenome, sexo, cpf, perfil, login, senha) VALUES 
('$nome', '$sobrenome', '$sexo', '$cpf', '$perfil', '$login', '$senha')");
echo "<font color=#333><center><br><br><br><br><br><h1>Cadastro realizado com sucesso</h1></center>";
mysqli_close($conexao);
?>


<center><a href="./cadastro1.php?p=formulario1">Clique aqui para </a> para novo cadastro</center>
</div>
</body>
</html>