...
<font color="black"> Pesquisa por Item
<form action="" method="post">
    ...
    $chamada = "SELECT * FROM itens WHERE nome LIKE '%".$pesquisar."%' or codigo = '".$pesquisar."' LIMIT 5";
		
    $chamada1 = mysqli_query($conexao, $chamada);
	while($chamada2 = mysqli_fetch_array($chamada1)){
		echo "<br>Codigo: ".$chamada2['codigo']."<br>";
		echo "Tipo de Item: ".$chamada2['tipoitem']."<br>";
		echo "Nome: ".$chamada2['nome']."<br>";
		echo "Descrição ".$chamada2['descricao']."<br><br>";
		echo "<a href='editaritens.php?codigo=".$chamada2['codigo']."'><img src='imagens/lapis1.png' style='max-width:30px'> Editar</a><br><br>";
