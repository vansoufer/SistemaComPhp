	...
	<form action="" method="post">
		...
		$chamada = "SELECT * FROM users WHERE nome LIKE '%".$pesquisar."%' or id = '".$pesquisar."' LIMIT 5";
			
		$chamada1 = mysqli_query($conexao, $chamada);
		while($chamada2 = mysqli_fetch_array($chamada1)){
			echo "<br>Código: ".$chamada2['id']."";
			echo "<br>Nome: ".$chamada2['nome']."<br>";
			echo "Sobrenome: ".$chamada2['sobrenome']."<br>";
			echo "Sexo: ".$chamada2['Sexo']."<br>";
			echo "CPF ".$chamada2['cpf']."<br>";
			echo "Perfil: ".$chamada2['perfil']."<br>";
			echo "Login: ".$chamada2['login']."<br>";
			echo "Senha: ".$chamada2['senha']."<br><br>";
			echo "<a href='editaruser.php?id=".$chamada2['id']."'><img src='imagens/lapis1.png' style='max-width:30px'> Editar</a><br><br>";
