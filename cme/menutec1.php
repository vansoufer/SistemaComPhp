...
<body background="imagens/logo1.png" bgproperties="fixed" >
 ...
 <div>
  ...
  <ul>
    ...
    <ul>
        <li ><a href="#" style="padding-top:18px;height:70px;"> Relatórios Ordem de Serviço<br><br><br> </a>
    <ul>
            <li><a href="relatorioperiodotec.php">Relatórios por Período</a></li>
            <li><a href="relatoriosetortec.php">Relatórios por Setor</a></li>
...
<div id="conteudoEsq"> 
		<nav class="navigation">
			...
			<a href="ostecnico.php"><img src="imagens/perfil.png"><br> Chamados<br><br><br></a>
			<a href="menutec1.php"><img src="imagens/relatorios.png"><br>Relatorios<br><br><br></a>
			<a href="contatotec1.php"><img src="imagens/telefone.png" style="max-width:30px"><br> Contato </a>
			</ul>
		</nav>
      </div>
      <div id="colEsq">
