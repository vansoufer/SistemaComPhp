 ...
 <div>
  ...
  <ul>
    <li><a href=""><img src="imagens/logo.png" height="50" width="100" border-left="5" border-right="5"/></a>
        <li><a href="ostecnico.php" style="padding-top:18px;height:70px;">Atender Chamados<br><br><br></a></li>  
    
    <ul>
        <li><a href="" style="padding-top:18px;height:70px;"> Pesquisar Chamados<br><br><br></a>
    ...
    <div id="conteudoEsq"> 
		<nav class="navigation">
			...
			<a href="cadastro1.php"><img src="imagens/home.png"><br> Chamados</a><br><br><br>
