...
$nome = $_POST['nome'];
$status = $_POST['status'];
$sql = mysqli_query($conexao,"INSERT INTO  setores (nome, status) VALUES ('$nome', '$status')");
echo "<font color=#333><center><br><br><br><br><br><h1>Cadastro realizado com sucesso</h1></center>";
mysqli_close($conexao);
?>
<center><a href="./cadastro1.php?p=formulario2">Clique aqui para </a> para novo cadastro</center>
</div>
</body>
</html>