...
<html>
 ...
 <?php
    ...
    $chamada = "SELECT * FROM itens WHERE codigo ='$id'";
...
<div class="campo"> 
<label for""><h4>Cadastro Itens</h4></label></div></fieldset>
<form action="alteraritens.php" method="post">
    ...
    <fieldset>
        <fieldset class="grupo">
            <div class="campo">
                ...
                <input type="text" id="tipoitem" name="tipoitem" value="<?php echo $row['tipoitem']; ?>" style="width: 10em">
            </div>
			</fieldset>
			<fieldset class="grupo">
            <div class="campo">
        ...
        <fieldset class="grupo">
            <div class="campo">
                ...
                <textarea name='descricao' value="<?php echo $row['descricao']; ?>" rows='5' cols='80'>
                </textarea>
           </div>
